                ...
                <div class="bg-white overflow-auto p-4">
                    <form action="{{ URL('/save-template') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="title" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#fff] dark:border-[#248991] dark:placeholder-gray-400 dark:text-gray-900 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Your title..." required>
                        </div>
                        <div class="mb-6">
                            <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-[#032738]">Your message</label>
                            <textarea id="message" name="content" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-[#248991] focus:ring-blue-500 focus:border-blue-500 dark:bg-[#fff] dark:border-[#248991] dark:placeholder-gray-400 dark:text-gray-900 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="content..."></textarea>
                        </div>
