        ...
        <main class="w-full flex-grow p-6">
            ...
            <div class="w-full mt-12">
                ...
                <div class="bg-white overflow-auto p-4">
                    <form action="{{ url('/save-lists') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-6">
                            <label for="body" class="block mb-2 text-sm font-medium text-gray-900 dark:text-[#032738]">Enter campaign Title</label>
                            <input type="text" name="title" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-[#fff] dark:border-[#248991] dark:placeholder-gray-400 dark:text-gray-900 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="campaign title..." />
                        </div>
